...
Config.define ({
  ...
  'site.books.header' : {
    title   : 'Ebooks & Documentación',
    caption : 'Catálogo de Publicaciones',
    lead    : `
      En esta sección se incluye la colección de publicaciones que he hecho para su descarga directa
      en formato pdf. Cada libro aborda en profundidad alguno de los perímetros de investigación en los
      que he trabajado.
    `
  },

  'site.books.catalog' : [{
    title   : 'Orientación a Componentes I',
    caption : 'Lenguajes & Programación',
    icon    : '@site.icons.light.development',
    image   : '/images/events/talks/talk.16.02.png',
    path    : '/libros/orientacion-a-componentes-i',
    author  : 'Javier Vélez',
    pages   : '232',
    draft   : true,
    hidden  : false,
    ...
    title   : 'Orientación a Componentes II',
    caption : 'Lenguajes & Programación',
    icon    : '@site.icons.light.development',
    image   : '/images/events/talks/talk.16.02.png',
    path    : '/libros/orientacion-a-componentes-ii',
    author  : 'Javier Vélez',
    pages   : '232',
    draft   : true,
    hidden  : false,
    ...
    title   : 'Orientación a Componentes III',
    caption : 'Lenguajes & Programación',
    icon    : '@site.icons.light.development',
    image   : '/images/events/talks/talk.16.02.png',
    path    : '/libros/orientacion-a-componentes-iii',
    author  : 'Javier Vélez',
    pages   : '232',
    draft   : false,
    hidden  : false,
    ...
    icon    : '@site.icons.light.development',
    image   : '/images/events/talks/talk.16.02.png',
    path    : '/libros/programacion-funcional',
    author  : 'Javier Vélez',
    pages   : '232',
    draft   : false,
    hidden  : false,
    lead    : `
      ...
      icon    : '@site.icons.light.development',
      image   : '/images/events/talks/talk.16.02.png',
      path    : '/libros/orientacion-a-objetos',
      author  : 'Javier Vélez',
      pages   : '232',
      draft   : false,
      hidden  : false,
